...
public class FollowCam : MonoBehaviour
{
    ...
    public Vector2 minXY = Vector2.zero; // Vector2 is [0,0]
    ...
    void FixedUpdate(){
        ...
        if(POI != null){
            //If the POI has a rigidbody, check to see if its is sleeping
    ...
    static public void SWITCCH_VIEW(eView newView){
